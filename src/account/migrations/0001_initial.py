...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Staff',
            fields=[
                ('staff_id', utils.validators.TitleCaseField(default='0298466252801030', max_length=16, primary_key=True, serialize=False, unique=True)),
                ('first_name', utils.validators.TitleCaseField(max_length=255)),
                ('middle_name', utils.validators.TitleCaseField(blank=True, max_length=255, null=True)),
